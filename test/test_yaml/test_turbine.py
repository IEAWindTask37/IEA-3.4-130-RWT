...
path2schema = os.path.dirname( os.path.dirname( os.path.dirname( os.path.realpath(__file__) ) ) ) + os.sep + 'windIO' + os.sep + 'windIO' + os.sep + 'turbine' + os.sep + "IEAontology_schema.yaml"

class TestRegression(unittest.TestCase):
    
    def test_IEA_3_4_130_RWT(self):
        
        path2yaml = os.path.dirname( os.path.dirname( os.path.dirname( os.path.realpath(__file__) ) ) ) + os.sep + 'yaml' + os.sep + "IEA-3.4-130-RWT.yaml"
        # Read the input yaml
