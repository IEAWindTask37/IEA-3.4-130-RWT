...
REAL(4), PARAMETER           :: PC_KI         =       0.004                   ! Integral gain for pitch controller at rated pitch (zero), (-).
...
REAL(4), PARAMETER           :: PC_KP         =       0.01334                   ! Proportional gain for pitch controller at rated pitch (zero), sec.
REAL(4), PARAMETER           :: PC_MaxPit     =       1.570796                  ! Maximum pitch setting in pitch controller, rad.
REAL(4), PARAMETER           :: PC_MaxRat     =       0.122111                  ! Maximum pitch  rate (in absolute value) in pitch  controller, rad/s.
REAL(4), PARAMETER           :: PC_MinPit     =       0.017444                  ! Minimum pitch setting in pitch controller, rad.
REAL(4), PARAMETER           :: PC_RefSpd     =     118.51100                   ! Desired (reference) HSS speed for pitch controller, rad/s.
...
REAL(4), PARAMETER           :: VS_MaxTq      =   31575.1353                    ! Maximum generator torque in Region 3 (HSS side), N-m. -- chosen to be 10% above VS_RtTq      = 000000.0 = 43.09355kNm
Real(4), PARAMETER           :: VS_RtTq       =   34732.64883                   ! Rated generator torque, Nm.
REAL(4), PARAMETER           :: VS_Rgn2K      =     2.0 !2.153                       ! Generator torque constant in Region 2 (HSS side), N-m/(rad/s)^2.
REAL(4), PARAMETER           :: VS_Rgn2Sp     =     15.7079632                  ! Transitional generator speed (HSS side) between regions 1 1/2 and 2, rad/s.
REAL(4), PARAMETER           :: VS_Rgn3MP     =       0.035                     ! Minimum pitch angle at which the torque is computed as if we are in region 3 regardless of the generator speed, rad. -- chosen to be 1.0 degree above PC_MinPit
REAL(4), PARAMETER           :: VS_RtGnSp     =     118.51100                   ! Rated generator speed (HSS side), rad/s. -- chosen to be 100% of PC_RefSpd
REAL(4), PARAMETER           :: VS_RtPwr      =   3438775.510204082             ! Rated generator power in Region 3, Watts. -- chosen to be 5MW divided by the electrical generator efficiency of 94.4%
